...
const Error = () => {
  ...
  <div className="min-w-screen min-h-screen bg-red-100 flex items-center p-5 lg:p-20 overflow-hidden relative">
    <div className="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
      <div className="w-full md:w-1/2">
        ...
        <div className="mb-10 md:mb-20 text-gray-600 font-light">
          <h1 onClick={ clickMe } className="font-black uppercase text-3xl lg:text-5xl text-red-500 mb-10">
            Oops!
          </h1>
        ...
        <Link href="/">
          <button className="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-red-500 hover:text-red-600">
          ...
          <br/>
          <button onClick={handleClick} className="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-red-500 hover:text-red-600">
            <i className="mdi mdi-home mr-2" />
            Go Home 2
          </button>
        </div>
    ...
    <div className="w-64 md:w-96 h-96 md:h-full bg-red-200 bg-opacity-30 absolute -top-64 md:-top-96 right-20 md:right-32 rounded-full pointer-events-none -rotate-45 transform" />
    <div className="w-96 h-full bg-red-200 bg-opacity-20 absolute -bottom-96 right-64 rounded-full pointer-events-none -rotate-45 transform" />
  </div>
  {/* <Image src="/crm/crm.png" height='262' width='600'></Image> */}
